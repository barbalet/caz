...
typedef struct CazEnvDroidSnapshot {
    ...
    float speed;
    float movement_total_ft;
    float movement_longest_streak_ft;
    float movement_current_streak_ft;
    float movement_rating;
    uint64_t movement_cycles;
    uint64_t movement_active_cycles;
    uint64_t movement_command_cycles;
    uint64_t movement_stall_cycles;
    uint64_t movement_spin_cycles;
    uint8_t program;
    uint8_t gait;
    uint8_t mode;
